...
export const updateIncident = async (req, res) => {
    const incident = await incidentService.updateIncident(req.params.id, req.body, req.authUser);
    return successResponse(res, { message: messages.incident.updatedSuccessfully, data: incident });
};

export const deleteIncident = async (req, res) => {
    const incident = await incidentService.softDeleteIncident(req.params.id, req.authUser);
    return successResponse(res, { message: "Incident deleted successfully", data: incident });
};

export const closeIncident = async (req, res) => {
    const id = req.params.id || req.params.incidentId;
    const incident = await incidentService.closeIncident(id, req.body, req.authUser);
...
export const getIncidentTimeline = async (req, res) => {
    ...
    return successResponse(res, { message: "Incident timeline fetched", data: timeline });
};

export const getIncidentArtifacts = async (req, res) => {
    const artifacts = await artifactService.listArtifactsByIncident(req.params.id);
    return successResponse(res, { message: "Incident artifacts fetched", data: artifacts });
};
...
export const createIncidentArtifact = async (req, res) => {
    ...
    return successResponse(res, { message: "Artifact created", data: artifact, statusCode: 201 });
};

export const getIncidentNotes = async (req, res) => {
    const notes = await incidentService.listIncidentNotes(req.params.id);
    return successResponse(res, { message: "Incident notes fetched", data: notes });
};
...
export const createIncidentNote = async (req, res) => {
    ...
    return successResponse(res, { message: "Incident note created", data: note, statusCode: 201 });
};

export const getRelatedIncidents = async (req, res) => {
    const related = await incidentService.getRelatedIncidents(req.params.id);
    return successResponse(res, { message: "Related incidents fetched", data: related });
};
...
export const updatePlaybook = async (req, res) => {
    const playbook = await playbookService.updatePlaybook(req.params.id, req.body, req.authUser);
    return successResponse(res, { message: messages.playbook.updatedSuccessfully, data: playbook });
};

export const deletePlaybook = async (req, res) => {
    const playbook = await playbookService.softDeletePlaybook(req.params.id, req.authUser);
    return successResponse(res, { message: messages.playbook.deletedSuccessfully, data: playbook });
};
...
export const updateArtifact = async (req, res) => {
    const artifact = await artifactService.updateArtifact(req.params.id, req.body, req.authUser);
    return successResponse(res, { message: "Artifact updated", data: artifact });
};

export const deleteArtifact = async (req, res) => {
    const artifact = await artifactService.softDeleteArtifact(req.params.id, req.authUser);
...
export const enrichArtifact = async (req, res) => {
    ...
    return successResponse(res, { message: "Artifact enrichment queued", data: result, statusCode: 202 });
};
...
export const enrichArtifactsBulk = async (req, res) => {
    ...
    return successResponse(res, { message: "Bulk enrichment queued", data: result, statusCode: 202 });
};
...
export const ingestCrowdStrikeWebhook = ingestWebhook(webhookService.ingestCrowdStrikeAlert);
export const ingestFortigateWebhook = ingestWebhook(webhookService.ingestFortigateAlert);
export const ingestWazuhWebhook = ingestWebhook(webhookService.ingestWazuhAlert);
export const ingestDefenderWebhook = ingestWebhook(webhookService.ingestDefenderAlert);
export const ingestSplunkWebhook = ingestWebhook(webhookService.ingestSplunkAlert);
export const ingestCustomWebhook = ingestWebhook(webhookService.ingestCustomAlert);
...
export const getWebhookSources = async (req, res) => {
    ...
    return successResponse(res, { message: "Webhook sources fetched", data: sources });
};

export const createWebhookSource = async (req, res) => {
    const source = await webhookService.createWebhookSource(req.body, req.authUser);
    return successResponse(res, { message: "Webhook source created", data: source, statusCode: 201 });
};

// ─── Connectors ──────────────────────────────────────────────────────────────

export const createConnector = async (req, res) => {
    const connector = await connectorService.createConnector(req.body, req.authUser);
    return successResponse(res, { message: "Connector created", data: connector, statusCode: 201 });
};
...
export const getConnector = async (req, res) => {
    ...
    return successResponse(res, { message: "Connector fetched", data: connector });
};

export const updateConnector = async (req, res) => {
    const connector = await connectorService.updateConnector(req.params.id, req.body, req.authUser);
    return successResponse(res, { message: "Connector updated", data: connector });
};

export const deleteConnector = async (req, res) => {
    const connector = await connectorService.softDeleteConnector(req.params.id, req.authUser);
    return successResponse(res, { message: "Connector deleted", data: connector });
};

export const testConnector = async (req, res) => {
    const result = await connectorService.testConnector(req.params.id, req.authUser);
    return successResponse(res, { message: "Connector test succeeded", data: result });
};

export const getConnectorActions = async (req, res) => {
    const result = await connectorService.listConnectorActions(req.params.id, req.query);
    return successResponse(res, { message: "Connector actions fetched", data: result });
};
...
export const createVaultEntry = async (req, res) => {
    ...
    return successResponse(res, { message: "Vault entry created", data: vault, statusCode: 201 });
};
...
export const updateVaultEntry = async (req, res) => {
    const vault = await vaultService.updateVaultEntry(req.params.id, req.body, req.authUser);
    return successResponse(res, { message: "Vault entry updated", data: vault });
};

export const deleteVaultEntry = async (req, res) => {
    const vault = await vaultService.softDeleteVaultEntry(req.params.id, req.authUser);
...
export const getDashboardOverview = async (req, res) => {
    ...
    return successResponse(res, { message: "Dashboard overview fetched", data: overview });
};
...
export const getDashboardAutomation = async (req, res) => {
    ...
    return successResponse(res, { message: "Automation dashboard fetched", data });
};

export const getDashboardConnectors = async (req, res) => {
    const data = await dashboardService.getConnectorsDashboard();
    return successResponse(res, { message: "Connectors dashboard fetched", data });
};
...
export const getAnalyticsReport = async (req, res) => {
    const data = await analyticsService.getAnalyticsReport(Number(req.query.days) || 30);
...
export const exportAnalytics = async (req, res) => {
    ...
    return successResponse(res, { message: "Analytics export queued", data: result, statusCode: 202 });
};
...
export const getSoarNotifications = async (req, res) => {
    const result = await notificationService.listSoarNotifications(req.authUser._id, req.query);
    return successResponse(res, {
...
export const markSoarNotificationRead = async (req, res) => {
    ...
    return successResponse(res, { message: "Notification marked read", data: notification });
};

export const markAllSoarNotificationsRead = async (req, res) => {
    const result = await notificationService.markAllNotificationsRead(req.authUser._id);
    return successResponse(res, { message: "Notifications marked read", data: result });
};
...
export const integrateGrcFinding = async (req, res) => {
    const result = await integrationService.pushGrcFinding(req.body, req.authUser);
    return successResponse(res, { message: "GRC finding pushed", data: result, statusCode: 201 });
};

export const integrateGrcRisk = async (req, res) => {
    const result = await integrationService.pushGrcRisk(req.body, req.authUser);
    return successResponse(res, { message: "GRC risk pushed", data: result, statusCode: 201 });
};

export const integrateUctcRule = async (req, res) => {
    const result = await integrationService.triggerUctcRule(req.body, req.authUser);
    return successResponse(res, { message: "UCTC rule triggered", data: result, statusCode: 202 });
};

export const integratePhishingCampaign = async (req, res) => {
    const result = await integrationService.pushPhishingCampaign(req.body, req.authUser);
    return successResponse(res, { message: "Phishing campaign linked", data: result, statusCode: 202 });
};
...
export const integrateIsolateHost = async (req, res) => {
    const result = await integrationService.isolateHostAction(req.body, req.authUser);
    return successResponse(res, { message: "Host isolation executed", data: result });
};

export const integrateSiemEvent = async (req, res) => {
    const result = await integrationService.pushSiemEvent(req.body, req.authUser);
    return successResponse(res, { message: "SIEM event pushed", data: result, statusCode: 201 });
};
