...
export const enrichmentQueue = new Bull(
  queueName("soar.enrichment"),
  redisConfig,
);
export const alertQueue = new Bull(queueName("soar.alert"), redisConfig);
export const soarNotificationQueue = new Bull(
  queueName("soar.notification"),
  redisConfig,
);
export const analyticsQueue = new Bull(
  queueName("soar.analytics"),
  redisConfig,
);
export const soarIntegrationQueue = new Bull(
  queueName("soar.integration"),
  redisConfig,
);
...
export const trackingQueue = new Bull(
  queueName("phishing.tracking"),
  redisConfig,
);
